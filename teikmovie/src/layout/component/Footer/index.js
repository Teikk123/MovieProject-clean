    ...
    return (
        <div className={cs('wrapper', className)}>
                ...
                <ul className={cs('list')}>
                    ...
                    <li className={cs('item')}>
                        <a href="" className={cs('item-link')}>
                            ...
                            Address : To 28-52-Triều Khúc- Thanh Xuân- Hà Nội
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <div className={cs('info', 'info_follow')}>
                ...
                <ul className={cs('list')}>
                    <li className={cs('item')}>
                        <a href="https://www.facebook.com/Teikk2553" target="_blank" className={cs('item-link')}>
                    ...
                    <li className={cs('item')}>
                        <a href="https://www.instagram.com/dkiet_02/" target="_blank" className={cs('item-link')}>
